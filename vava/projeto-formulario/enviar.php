<?php
  ...
  $mail->FromName = "Gabriel Souza"; // Nome da conta de email
  // DADOS DO DESTINAT�RIO
  $mail->AddAddress('gabrielbsouzadev@gmail.com', 'Nome - Recebe1'); // Define qual conta de email receber� a mensagem
